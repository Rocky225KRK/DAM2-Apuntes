...
public class EditorIngredientsAdapter extends RecyclerView.Adapter<EditorIngredientsAdapter.ViewHolder>{
    ...
    public EditorIngredientsAdapter(Context context, List<Ingredient> ingredients, IngredientAdapterListener listener) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new EditorIngredientsAdapter.ViewHolder(row);
    }

    @Override
    public void onBindViewHolder(@NonNull ViewHolder holder, int NOT_USE) {
        Ingredient current= ingredients.get(holder.getAdapterPosition());
        ...
        holder.llyArtifactRow.setOnClickListener(view -> {
            ...
            if (this.posSelect==position){
                ...
                if(listener!=null){
                    listener.onIngredientSelected(current);
                }
            }
        });
    }
